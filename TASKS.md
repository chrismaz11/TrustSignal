...
- [x] Push remediation commits in PR `https://github.com/TrustSignal-dev/TrustSignal/pull/11` and rerun required checks until green (`https://github.com/TrustSignal-dev/TrustSignal/actions/runs/22801986229`).
