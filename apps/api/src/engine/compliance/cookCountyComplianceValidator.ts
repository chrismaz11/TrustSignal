// Engine-owned compliance evaluation. Keep public gateway code behind the
// verification engine interface rather than importing this module directly.
...
export class CookCountyComplianceValidator {
    ...
    private extractTextFromPdf(pdfBuffer: Buffer): Promise<string> {
        return new Promise((resolve, reject) => {
            ...
            pdfParser.on("pdfParser_dataError", (errData: PdfParserErrorEvent) => reject(errData.parserError));
