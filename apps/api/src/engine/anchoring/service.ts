// Engine-owned anchoring workflow. Public gateway code should call this
// through the verification engine boundary.
...
import type { ZKPAttestation } from '../../../../../packages/public-contracts/dist/index.js';

export { ANCHOR_SUBJECT_VERSION } from '../../../../../packages/engine-internal/dist/index.js';
